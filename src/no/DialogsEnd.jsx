...
export default function DialogsEnd({ sfx }) {
  ...
  const [textos, setTextos] = useState([
    ...
    "Ya los modales no existen en estos tiempos, tienen nula responsabilidad afectiva...",
    ...
    localStorage.getItem('d1d1-yes') !== 'completed' ? 'Tranqui, ya entendí la indirecta, bloquearé todo lo demás. Ya no es necesario que lo veas.' : 'Ni te dignaste en ver la otra opción. Entonces no habrá problema si lo dejas así.',
  ]);
